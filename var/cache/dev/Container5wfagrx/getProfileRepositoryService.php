...
// Returns the private 'App\Repository\ProfileRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\ProfileRepository.php';

return $this->services['App\Repository\ProfileRepository'] = new \App\Repository\ProfileRepository(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->getDoctrineService()) && false ?: '_'});
