...
class __TwigTemplate_a3d92163f655029345e69e9333d282aab0cb9dec2e2869e56e5af30eac26b63f extends Twig_Template
{
    private $source;
                    ...
                    <div class=\"card-block\">
                        <div class=\"row\">
                            <div class=\"col col-4\">
                                ...
                                <pre class=\"prewrap\">";
                    // line 193
                    echo twig_escape_filter($this->env, twig_replace_filter(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["message"], "headers", array()), "get", array(0 => "from"), "method"), "toString", array()), array("From:" => "")), "html", null, true);
                    echo "</pre>

                                <span class=\"label\">To</span>
                                <pre class=\"prewrap\">";
                    // line 196
                    echo twig_escape_filter($this->env, twig_replace_filter(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["message"], "headers", array()), "get", array(0 => "to"), "method"), "toString", array()), array("To:" => "")), "html", null, true);
                    echo "</pre>
                            </div>
                            <div class=\"col\">
...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", "@Swiftmailer/Collector/swiftmailer.html.twig", "/var/www/DDProjektas/vendor/symfony/swiftmailer-bundle/Resources/views/Collector/swiftmailer.html.twig");
    }
}
