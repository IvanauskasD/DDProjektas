...
class __TwigTemplate_bde3a957f2f167687cd5c466c049d27bbf9d2756f84d4ab49513b91fcabc5f60 extends Twig_Template
{
    private $source;
        ...
        <table class=\"decision-log\">
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["decision"]) {
                ...
                if ((twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, $context["decision"], "attributes", array())) == 1)) {
                    // line 320
                    echo "                                ";
                    echo twig_escape_filter($this->env, twig_first($this->env, twig_get_attribute($this->env, $this->source, $context["decision"], "attributes", array())), "html", null, true);
                    echo "
                            ";
                } else {
                    // line 322
...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "@Security/Collector/security.html.twig", "/var/www/DDProjektas/vendor/symfony/security-bundle/Resources/views/Collector/security.html.twig");
    }
}
