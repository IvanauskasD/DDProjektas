...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Form\\CompanyForm' => function () {
    return ${($_ = isset($this->services['App\Form\CompanyForm']) ? $this->services['App\Form\CompanyForm'] : $this->services['App\Form\CompanyForm'] = new \App\Form\CompanyForm()) && false ?: '_'};
...
}, 'App\\Form\\UserForm' => function () {
    return ${($_ = isset($this->services['App\Form\UserForm']) ? $this->services['App\Form\UserForm'] : $this->services['App\Form\UserForm'] = new \App\Form\UserForm()) && false ?: '_'};
