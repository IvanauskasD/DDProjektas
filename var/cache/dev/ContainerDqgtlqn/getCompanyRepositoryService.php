...
// Returns the private 'App\Repository\CompanyRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\CompanyRepository.php';

return $this->services['App\Repository\CompanyRepository'] = new \App\Repository\CompanyRepository(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->getDoctrineService()) && false ?: '_'});
